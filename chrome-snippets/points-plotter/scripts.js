...
document.addEventListener('DOMContentLoaded', () => {
	...
	if( dragHandle) {
    	dragHandle.addEventListener("drag", dragCircle);
	}	
...
function dragCircle(event) {
    ...
    */
	...
	if(mainHip.cata.y2 <= 0 && mainHip.cata.x2 >= 0) {
		...
		let txt_elevation = document.getElementById('txt-elevation');
		txt_elevation.setAttributeNS(null, 'x', nextPoint.x);
		txt_elevation.setAttributeNS(null, 'y', nextPoint.y);
		txt_elevation.innerHTML = elevationLineLength;
